...
public class ClienteCargarDatos implements CommandLineRunner {
	...
	@Autowired
	IServicioTicket servicioTicket;
	...
	public void run(String... args) throws Exception {
		if (!datosCargados) {
			...
			// ---------- TARJETA BASE ----------
            DTOtarjetaBancariaSubida tarjetaBase = DTOtarjetaBancariaSubida.builder()
                    .nombreTitular("Usuario Ejemplo")
                    .nTarjeta("1234567890123456")
                    .fechaCaducidad(LocalDate.of(2028, 12, 31))
                    .cvv("123")
                    .saldo(BigDecimal.valueOf(1000.0))
                    .build();

            
            // ---------- USUARIOS ----------
            DTOusuarioSubida vendedor = DTOusuarioSubida.builder()
                    .nombre("Vendedor")
            ...
            DTOusuarioSubida cliente = DTOusuarioSubida.builder()
                    .nombre("Cliente")
            ...
            DTOusuarioSubida admin = DTOusuarioSubida.builder()
                    .nombre("Administrador")
                    .email("admin@mail.com")
                    .password("1234")
                    .fechaNacimiento(LocalDate.now().minusYears(35))
                    .rol(Rol.ADMIN)
                    .reportado(false)
                    .cuenta(tarjetaBase)
                    .build();
			...
			DTOusuarioSubida u3 = DTOusuarioSubida.builder()
				...
				DTOusuarioBajada vendedorGuardado = servicioUsuario.registerConDatos(vendedor);
	            DTOusuarioBajada clienteGuardado = servicioUsuario.registerConDatos(cliente);
	            DTOusuarioBajada adminGuardado = servicioUsuario.registerConDatos(admin);

			servicioUsuario.registerConDatos(u3);
			servicioUsuario.registerConDatos(u4);
			...
			DTOeventoSubida e1 = DTOeventoSubida.builder().nombre("Festival de Música Electrónica")
			        ...
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1661284892176-fd7713b764a6?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1661377118520-287ec60a32f3?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1663051210654-0c8a835dad1f?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					...
					.invitados(List.of(DTOInvitadoSubida.builder().nombre("Carlos").apellidos("Gómez")
							.fotoBase64("https://tse3.mm.bing.net/th/id/OIP.J7mTXL5Pjfk7_ik14ZfQGgHaE8?pid=Api&P=0&h=180")
							.descripcion("DJ residente en Madrid").build(),
							DTOInvitadoSubida.builder().nombre("Laura").apellidos("Martínez").fotoBase64(
			...
			DTOeventoSubida e2 = DTOeventoSubida.builder().nombre("Concierto de Rock").localizacion("Barcelona, España")
			        ...
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1681876467464-33495108737c?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1629276301687-be2af9fd6ba8?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1613423085580-d1b9e13e27b8?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .precio(50.0)
			        .categoria(Categoria.MUSICA)
			        .invitados(List.of(DTOInvitadoSubida.builder().nombre("Miguel").apellidos("López").fotoBase64(
							...
							DTOInvitadoSubida.builder().nombre("Sofía").apellidos("Ramírez").fotoBase64(
			...
			DTOeventoSubida e3 = DTOeventoSubida.builder().nombre("Exposición de Arte Moderno")
					...
					.imagenesCarrusel("https://images.unsplash.com/photo-1531913764164-f85c52e6e654?q=80&w=1468&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagenesCarrusel("https://images.unsplash.com/photo-1665148553316-0b451be0614f?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagenesCarrusel("https://plus.unsplash.com/premium_photo-1711987692262-0d3aca86fc1d?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1706548911842-7162d4bd2c98?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .precio(13.75)
			        .categoria(Categoria.ARTE)
			        .invitados(List.of(DTOInvitadoSubida.builder().nombre("Ana").apellidos("García")
							.fotoBase64("https://tse2.mm.bing.net/th/id/OIP.eWcoK30BjXpz7CO3rkmaqgHaHa?pid=Api&P=0&h=180")
							.descripcion("Curadora de la exposición").build(),
							DTOInvitadoSubida.builder().nombre("Javier").apellidos("Hernández").fotoBase64(
			...
			DTOeventoSubida e4 = DTOeventoSubida.builder().nombre("Torneo de eSports").localizacion("Sevilla, España")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1636487658547-c05ee4cdc1ac?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagenesCarrusel("https://plus.unsplash.com/premium_photo-1683141331949-64810cfc4ca3?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1587095951604-b9d924a3fda0?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1558008258-7ff8888b42b0?q=80&w=1631&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					...
					.invitados(List.of(DTOInvitadoSubida.builder().nombre("Lucas").apellidos("Moreno")
							.fotoBase64("https://tse3.mm.bing.net/th/id/OIP.sSPR3mdA7rRLoQ9Y2MURkgAAAA?pid=Api&P=0&h=180")
							.descripcion("Jugador profesional de League of Legends").build(),
							DTOInvitadoSubida.builder().nombre("Marta").apellidos("Sánchez")
									.fotoBase64("https://randomuser.me/api/portraits/women/50.jpg")
			...
			DTOeventoSubida e5 = DTOeventoSubida.builder().nombre("Maratón Solidario").localizacion("Bilbao, España")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1524646349956-1590eacfa324?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1581889470536-467bdbe30cd0?q=80&w=1564&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					...
					.invitados(List.of(DTOInvitadoSubida.builder().nombre("Elena").apellidos("Torres").fotoBase64(
							...
							DTOInvitadoSubida.builder().nombre("Pedro").apellidos("Alonso").fotoBase64(
			...
			DTOeventoSubida e6 = DTOeventoSubida.builder().nombre("Carrera de Aventura Montaña y Río")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1498581444814-7e44d2fbe0e2?q=80&w=1398&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagenesCarrusel("https://images.unsplash.com/photo-1667205742805-b5154830522b?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1600818596647-9d5318c20a8a?q=80&w=1584&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					...
					.categoria(Categoria.DEPORTES)
					.invitados(List.of(
							DTOInvitadoSubida.builder().nombre("Sofía").apellidos("Jiménez")
									.fotoBase64("https://randomuser.me/api/portraits/women/65.jpg")
									.descripcion("Guía de montaña y organizadora").build(),
									DTOInvitadoSubida.builder().nombre("Miguel").apellidos("Sánchez")
									.fotoBase64("https://randomuser.me/api/portraits/men/41.jpg")
			...
			DTOeventoSubida e7 = DTOeventoSubida.builder().nombre("Feria Internacional del Libro")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1544185310-0b3cf501672b?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1718745015015-09cd064a263b?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1660606422784-5a18d4be40fe?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1713720662476-0bf9c2d59308?q=80&w=1402&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagen("https://images.unsplash.com/photo-1519682337058-a94d519337bc")
					.precio(15.3)
					.categoria(Categoria.OTROS)
					.invitados(List.of(
							DTOInvitadoSubida.builder().nombre("Isabel").apellidos("Allende")
									.fotoBase64("https://randomuser.me/api/portraits/women/50.jpg")
									.descripcion("Escritora invitada").build(),
									DTOInvitadoSubida.builder().nombre("Juan").apellidos("Gómez Jurado")
									.fotoBase64("https://randomuser.me/api/portraits/men/61.jpg")
			...
			DTOeventoSubida e8 = DTOeventoSubida.builder().nombre("Torneo Juvenil de Fútbol")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1622659097509-4d56de14539e?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1526232761682-d26e03ac148e?q=80&w=1429&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1664303712613-98938c99f827?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1600077063877-22118d6290eb?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1622659097574-c814ee26068e?q=80&w=1382&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					...
					.categoria(Categoria.DEPORTES)
					.invitados(List.of(
							DTOInvitadoSubida.builder().nombre("Andrés").apellidos("Iniesta")
									.fotoBase64("https://randomuser.me/api/portraits/men/70.jpg")
									.descripcion("Exjugador profesional, invitado especial").build(),
									DTOInvitadoSubida.builder().nombre("Marta").apellidos("López")
									.fotoBase64("https://randomuser.me/api/portraits/women/22.jpg")
			...
			DTOeventoSubida e9 = DTOeventoSubida.builder().nombre("Tech Future Conference")
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1600320261634-78edd477fa1e?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
					.imagenesCarrusel("https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1683120966127-14162cdd0935?q=80&w=726&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1582192730841-2a682d7375f9?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .precio(35.0)
			        .categoria(Categoria.VIDEOJUEGOS)
			        .imagen("https://images.unsplash.com/photo-1519389950473-47ba0277781c")
					.invitados(List.of(
							DTOInvitadoSubida.builder().nombre("Ana").apellidos("García")
									.fotoBase64("https://randomuser.me/api/portraits/women/30.jpg")
									.descripcion("CEO de startup tecnológica").build(),
									DTOInvitadoSubida.builder().nombre("David").apellidos("Fernández")
									.fotoBase64("https://randomuser.me/api/portraits/men/80.jpg")
			...
			DTOeventoSubida e10 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1647814568764-3bf5ed6b3c7b?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1675813863340-b7e84c4a1fb0?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1578163678052-eef169544f75?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1677609898243-63280b6c89a1?q=80&w=766&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .precio(23.4)
			        .categoria(Categoria.ARTE)
					...
					.invitados(List.of(
							DTOInvitadoSubida.builder().nombre("Lucía").apellidos("Morales")
									.fotoBase64("https://randomuser.me/api/portraits/women/60.jpg")
									.descripcion("Artista expositora").build(),
									DTOInvitadoSubida.builder().nombre("Pablo").apellidos("Ruiz")
									.fotoBase64("https://randomuser.me/api/portraits/men/50.jpg")
			...
			DTOeventoSubida e11 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1504674900247-0877df9cc836")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1482049016688-2d3e1b311543?q=80&w=710&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1484723091739-30a097e8f929?q=80&w=749&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        ...
			        .categoria(Categoria.OTROS)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Ferran").apellidos("Adrià")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/12.jpg")
			                        .descripcion("Chef internacional invitado").build(),
			                        DTOInvitadoSubida.builder().nombre("María").apellidos("Rodríguez")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/72.jpg")
			...
			DTOeventoSubida e12 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1604975701397-6365ccbd028a?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1536440136628-849c177e76a1")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1574267432553-4b4628081c31?q=80&w=1631&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1608170825938-a8ea0305d46c?q=80&w=1025&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        ...
			        .categoria(Categoria.OTROS)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Hideo").apellidos("Kojima")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/90.jpg")
			                        .descripcion("Director invitado especial").build(),
					        		DTOInvitadoSubida.builder().nombre("Marquees").apellidos("Brownlee")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/91.jpg")
			                        .descripcion("Youtuber").build(),
			                        DTOInvitadoSubida.builder().nombre("Elena").apellidos("Martínez")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/38.jpg")
			...
			DTOeventoSubida e13 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1580832945253-9a8f87b606f2?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/flagged/photo-1569231290377-072234d3ee57?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1511379938547-c1f69419868d")
			        ...
			        .categoria(Categoria.MUSICA)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Herbie").apellidos("Hancock")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/55.jpg")
			                        .descripcion("Pianista y compositor de jazz").build(),
			                        DTOInvitadoSubida.builder().nombre("Nina").apellidos("Simone Jr.")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/89.jpg")
			...
			DTOeventoSubida e14 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1487452066049-a710f7296400?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1693000474956-1a5d8a85befc?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://plus.unsplash.com/premium_photo-1692311474471-4ee63c95c5e1?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1548003693-b55d51032288?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        ...
			        .categoria(Categoria.ARTE)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Bansky").apellidos("")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/42.jpg")
			                        .descripcion("Artista urbano invitado").build(),
			                        DTOInvitadoSubida.builder().nombre("María").apellidos("González")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/65.jpg")
			...
			DTOeventoSubida e15 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://images.unsplash.com/photo-1577471488278-16eec37ffcc2?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1519766304817-4f37bda74a26?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/photo-1546519638-68e109498ffc?q=80&w=1490&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        .imagenesCarrusel("https://images.unsplash.com/flagged/photo-1580051579393-2e94dd6f4789?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
			        ...
			        .categoria(Categoria.DEPORTES)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Pau").apellidos("Gasol")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/77.jpg")
			                        .descripcion("Exjugador de la NBA y embajador del evento").build(),
			                        DTOInvitadoSubida.builder().nombre("Elena").apellidos("Rodríguez")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/44.jpg")
			...
			DTOeventoSubida e16 = DTOeventoSubida.builder()
			        ...
			        .imagenesCarrusel("https://i.blogs.es/7605fd/league-of-legends-worlds/1366_2000.jpg")
			        .imagenesCarrusel("https://i.blogs.es/abcea5/league-of-legends-worlds-04/1366_2000.jpg")
			        .imagenesCarrusel("https://i.blogs.es/fa6774/league-of-legends-worlds-05/1366_2000.jpg")
			        .imagenesCarrusel("https://i.blogs.es/2178b8/league-of-legends-worlds-03/1366_2000.jpg")
			        .imagen("https://i.blogs.es/15f158/league-of-legends-worlds-02/1366_2000.jpg")
			        .precio(45.0)
			        .categoria(Categoria.VIDEOJUEGOS)
			        .invitados(List.of(
			        		DTOInvitadoSubida.builder().nombre("Carlos").apellidos("Ocelote Rodríguez")
			                        .fotoBase64("https://randomuser.me/api/portraits/men/29.jpg")
			                        .descripcion("Exjugador profesional y fundador de G2 Esports").build(),
			                        DTOInvitadoSubida.builder().nombre("Marta").apellidos("López")
			                        .fotoBase64("https://randomuser.me/api/portraits/women/71.jpg")
			...
			// ---------- TICKETS ----------
            DTOticketSubida ticket1 = DTOticketSubida.builder()
                    .usuarioId(clienteGuardado.getId())
                    .eventoId(eventoBajada.getId())
                    .precio(eventoBajada.getPrecio())
                    .build();

            DTOticketSubida ticket2 = DTOticketSubida.builder()
                    .usuarioId(clienteGuardado.getId())
                    .eventoId(eventoBajada.getId())
                    .precio(eventoBajada.getPrecio())
                    .build();

            servicioTicket.insert(ticket1);
            servicioTicket.insert(ticket2);
