    ...
    return (
        <div className="mt-4 px-2 md:px-0 text-gray-500 ">
            ...
            <form onSubmit={crearEvento} className="flex flex-col bg-white p-4 rounded  mb-4 gap-4 oscuro">
                ...
                <button type="button" onClick={agregarInvitado} className="bg-gray-500 text-white mt-6 p-2 rounded hover:bg-blue-600 transition w-40">Agregar invitado</button>

                <div className="flex flex-col gap-4 mt-4 items-end">
                    <button type="submit" className="bg-green-500 text-white p-2 rounded  hover:bg-green-600 transition mt-4 w-full md:w-30 self-end">Crear evento</button>
                </div>
            </form>
